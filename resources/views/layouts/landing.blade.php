...
<div id="navigation" class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#"><b>{{ trans('adminlte_lang::message.app_name') }}</b></a>
        </div>
...
<div id="headerwrap">
    <div class="container">
        <div class="row centered">
            <div class="col-lg-12">
                <h1> <b><a href="https://github.com/acacha/adminlte-laravel">{{ trans('adminlte_lang::message.app_name') }}</a></b></h1>
